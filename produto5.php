      ...
      <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/galaxyw.png" alt="Imagem do Produto">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Galaxy Watch4 Classic</h2>
                <p class="product-price2">R$ 971</p>
                <p class="product-description2">Galaxy Watch4 Classic BT 46mm Preto.</p>
                <a href="pagamento.php?id=5" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=5" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
