    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/s23.png" alt="Imagem do Produto">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Samsung Galaxy S23 Ultra</h2>
                <p class="product-price2">R$ 5.799</p>
                <p class="product-description2">Samsung Galaxy S23 Ultra Dual SIM 256 GB phantom black 12 GB RAM.</p>
                <a href="pagamento.php?id=6" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=6" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
