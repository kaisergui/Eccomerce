    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/iphone14-preto.png" alt="Imagem do Produto">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Iphone 14</h2>
                <p class="product-price2">R$ 7.599</p>
                <p class="product-description2">iPhone 14 (128 GB) - Preto.</p>
                <a href="pagamento.php?id=1" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=1" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
