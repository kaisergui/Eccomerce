    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/ipad-pro_specs__bnuyb5pohkly_og.png" alt="Imagem do Produto" style="max-width:590px;">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">iPad Pro</h2>
                <p class="product-price2">R$ 23.849</p>
                <p class="product-description2">Apple iPad Pro 12,9" (6ª geração, Wi-Fi, 2TB) - Cinza-espacial.</p>
                <a href="pagamento.php?id=7" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=7" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
