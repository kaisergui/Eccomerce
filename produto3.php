    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/notebook-alienware-m16-hd-black-gallery-13.png" alt="Imagem do Produto" style="max-width:590px;">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Notebook Gamer Alienware m16</h2>
                <p class="product-price2">R$ 17.229</p>
                <p class="product-description2">Notebook Dell Alienware m16 AW16-i1300-M10P 16" QHD 13ª Geração Intel Core i9 16GB 1TB SSD RTX 4060 Windows 11</p>
                <a href="pagamento.php?id=3" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=3" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
