    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/tab.jpg" alt="Imagem do Produto" style="max-width:590px;">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Galaxy Tab S8 Ultra 5G</h2>
                <p class="product-price2">R$ 6.749</p>
                <p class="product-description2">Tablet Samsung Galaxy Tab S8+ 5G, 8GB RAM, 256GB, Tela de 12.4" Prata.</p>
                <a href="pagamento.php?id=8" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=8" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
