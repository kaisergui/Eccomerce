    ...
    <div class="container2">
        <div class="product">
            <div class="product-image2">
                <img src="images/Macbook-PNG-Image-File.png" alt="Imagem do Produto">
            </div>
            <div class="product-details2">
                <h2 class="product-title2">Apple Macbook Air M1</h2>
                <p class="product-price2">R$ 6.150</p>
                <p class="product-description2">Apple Macbook Air (13 polegadas, 2020, Chip M1, 256 GB de SSD, 8 GB de RAM) - Cinza-espacial</p>
                <a href="pagamento.php?id=2" class="product-button2">Comprar</a>
                <a href="carrinhocompra.php?id=2" class="product-button2">Adicionar ao carrinho</a>
            </div>
        </div>
    </div>
